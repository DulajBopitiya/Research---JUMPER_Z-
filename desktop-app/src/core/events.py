...
# ============================================================
    ...
    # Tabs & Focus
        ...
        EDITOR_TAB_CHANGED = "ui.editor_tab_changed"

        # Panels
        BOTTOM_PANEL_RESIZED = "ui.bottom_panel_resized"
        BOTTOM_PANEL_TOGGLED  = "ui.bottom_panel_toggled"

        #Indicators
        STATUS_MESSAGE_SET    = "ui.status_message_set"
        ACTIVITY_STARTED   = "ui.activity_started"
        ACTIVITY_FINISHED   = "ui.activity_finished"
    ...
    def list_all_events_by_group():
        ...
        result = {}
        for group_name, group_obj in _EventsRegistry.__dict__.items():
            if isinstance(group_obj, type):  # Only classes
                # Only take string constants, skip private/internal names
                result[group_name] = [
                    v for k, v in group_obj.__dict__.items()
    ...
    def print_events_table():
        ...
        events = _EventsRegistry.list_all_events_by_group()
...
Events: Final[_EventsRegistry] = _EventsRegistry()
